...
import { StoreTypes } from '../interfaces/store-types';
...
export class StoreService {
  ...
  //retorna objeto os produtos de uma categoria especifica
  public findCP(c: string) {  //retorna objeto com os produtos de uma categoria especifica
    let products: any;
  ...
  public allCategorys() {  //retorna string com todas as categorias para criar rotas de categorias
    let categorys: Array<string> = [];
    this.content.forEach(item => {
  ...
  public allProducts(obj: boolean) {
  ...
  public getProduct(i: string) {  //retorna um objeto com um produto especifico
    let product: Object = {};
    this.content.forEach(item => {
      item.produtos.forEach(prod => {
        if (i == prod.name) {
